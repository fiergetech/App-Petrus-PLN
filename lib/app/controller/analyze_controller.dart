...
import 'package:handyman_freelancer/app/backend/model/analytics_model.dart';
import 'package:handyman_freelancer/app/backend/model/months_analytics_model.dart';
import 'package:handyman_freelancer/app/backend/model/yearly_analytics_model.dart';
...
class AnalyzeController extends GetxController implements GetxService {
  final AnalyzeParser parser;
  ...
  AnalyzeController({required this.parser});
