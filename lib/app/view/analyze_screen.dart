...
class _AnalyzeScreenState extends State<AnalyzeScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AnalyzeController>(builder: (value) {
      Map<int, Widget> myTabs = <int, Widget>{
        0: Text(
          "Daily".tr,
          style: TextStyle(
              color:
                  Get.find<AnalyzeController>().segmentedControlGroupValue == 0
        ...
        1: Text("Monthly".tr,
            style: TextStyle(
                color:
                    Get.find<AnalyzeController>().segmentedControlGroupValue ==
                            1
                        ? ThemeProvider.whiteColor
                        : ThemeProvider.blackColor)),
        2: Text("Yearly".tr,
      ...
      Map<int, Widget> myTabsProducts = <int, Widget>{
        0: Text(
          "Daily".tr,
          style: TextStyle(
              color: Get.find<AnalyzeController>()
  ...
  SfCartesianChart _buildChart() {
    return SfCartesianChart(
      ...
      title: ChartTitle(
          text:
              '${'Total number of bookings'.tr} ${Get.find<AnalyzeController>().getName()}',
      ...
      primaryYAxis: NumericAxis(
          ...
          labelFormat: '{value}${Get.find<AnalyzeController>().currencySymbol}',
  ...
  SfCartesianChart _buildChartProducts() {
    return SfCartesianChart(
      ...
      title: ChartTitle(
          text:
              '${'Total number of orders'.tr} ${Get.find<AnalyzeController>().getName()}',
          textStyle: const TextStyle(fontSize: 10)),
      primaryXAxis: CategoryAxis(
        majorGridLines: const MajorGridLines(width: 0),
      ),
  ...
  SfCartesianChart _buildChartForMonths() {
    return SfCartesianChart(
      ...
      title: ChartTitle(
          text:
              '${'Total number of bookings'.tr} ${Get.find<AnalyzeController>().currenyYear}',
          textStyle: const TextStyle(fontSize: 10)),
      primaryXAxis: CategoryAxis(
        majorGridLines: const MajorGridLines(width: 0),
      ),
  ...
  SfCartesianChart _buildChartForMonthsProducts() {
    return SfCartesianChart(
      ...
      title: ChartTitle(
          text:
              '${'Total number of orders'.tr} ${Get.find<AnalyzeController>().currenyYear}',
          textStyle: const TextStyle(fontSize: 10)),
      primaryXAxis: CategoryAxis(
        majorGridLines: const MajorGridLines(width: 0),
      ),
    ...
    return <ColumnSeries<ChartSampleData, String>>[
      ColumnSeries<ChartSampleData, String>(
        dataSource: <ChartSampleData>[
          for (var item in Get.find<AnalyzeController>().list)
            ChartSampleData(
                x: item.dayName,
                y: item.total,
  ...
  List<ColumnSeries<ChartSampleData, String>> _getWeekDataProducts() {
    return <ColumnSeries<ChartSampleData, String>>[
      ColumnSeries<ChartSampleData, String>(
        dataSource: <ChartSampleData>[
          for (var item in Get.find<AnalyzeController>().listProducts)
            ChartSampleData(
                x: item.dayName,
                y: item.total,
                pointColor: ThemeProvider.appColor),
  ...
  List<ColumnSeries<ChartSampleData, String>> _getMonthsData() {
    return <ColumnSeries<ChartSampleData, String>>[
      ColumnSeries<ChartSampleData, String>(
        dataSource: <ChartSampleData>[
          for (var item in Get.find<AnalyzeController>().monthList)
            ChartSampleData(
                x: Get.find<AnalyzeController>()
  ...
  List<ColumnSeries<ChartSampleData, String>> _getMonthsDataProducts() {
    return <ColumnSeries<ChartSampleData, String>>[
      ColumnSeries<ChartSampleData, String>(
        dataSource: <ChartSampleData>[
          for (var item in Get.find<AnalyzeController>().monthListProducts)
            ChartSampleData(
                x: Get.find<AnalyzeController>()
                    .monthsListNames[item.dayName as int],
                y: item.total,
  ...
  List<ColumnSeries<ChartSampleData, String>> _getYearlyData() {
    return <ColumnSeries<ChartSampleData, String>>[
      ColumnSeries<ChartSampleData, String>(
        dataSource: <ChartSampleData>[
          for (var item in Get.find<AnalyzeController>().yearlyList)
            ChartSampleData(
  ...
  List<ColumnSeries<ChartSampleData, String>> _getYearlyDataProducts() {
    return <ColumnSeries<ChartSampleData, String>>[
      ColumnSeries<ChartSampleData, String>(
        dataSource: <ChartSampleData>[
          for (var item in Get.find<AnalyzeController>().yearlyListProducts)
            ChartSampleData(
                x: item.dayName.toString(),
                y: item.total,
                pointColor: ThemeProvider.appColor),
